...
def run_npy_to_sumbit_csv():
    ...
    npy_dir   = '/root/share/project/kaggle/science2018/results/unet-se-resnext50-7/predict/xx_gray_identity/masks'

    submit_dir  = \
        '/root/share/project/kaggle/science2018/results/unet-se-resnext50-7/submit'
    csv_file = submit_dir  + '/submission-gray.csv'
