...
class FeatureNet(nn.Module):
    ...
    def __init__(self, cfg, in_channels, out_channels=256 ):
        ...
        self.layer_c1 = make_layer_c(   64,  64,  256, groups= 16, num_blocks= 3, stride=1)  #out =  64*4 =  256
        self.layer_c2 = make_layer_c(  256, 128,  512, groups= 32, num_blocks= 4, stride=2)  #out = 128*4 =  512
        self.layer_c3 = make_layer_c(  512, 256, 1024, groups= 64, num_blocks=23, stride=2)  #out = 256*4 = 1024
        self.layer_c4 = make_layer_c( 1024, 512, 2048, groups=128, num_blocks= 3, stride=2)  #out = 512*4 = 2048
...
class UNet(nn.Module):
    ...
    def criterion(self, foregrounds_truth, cuts_truth):
        ...
        def make_weight(labels_truth, pos_weight=0.5, neg_weight=0.5):
            ...
            neg = B*C*H*W - pos
            if pos>0:
                pos_weight = pos_weight/pos
                neg_weight = neg_weight/neg
            else:
                pos_weight = 0
                neg_weight = 0
        ...
        #balanced
        foregrounds_weight = make_weight(foregrounds_truth, 0.5,0.5 )
        cuts_weight = make_weight(cuts_truth, 0.01,0.99)
